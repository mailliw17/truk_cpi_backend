                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4"> <strong>Registrasi Akun Operator Barcode Baru</strong> </h1>
                            <hr>
                        ...
                        <form class="user" method="POST" action="<?= base_url('C_auth/registerminiadmin'); ?>">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="email" autocomplete="off" id="email" placeholder="Masukan email" value="<?= set_value('email'); ?>">
